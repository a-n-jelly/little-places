...
insert into places (name, type, address, description, stages, accessibility, tags, lat, lng, rating, submitted_by) values
...
('Green Lake Park', 'Park', '7201 E Green Lake Dr N, Seattle, WA 98115',
 ...
 array['Pram Accessible','Free Entry','Fenced Area'], 47.6803, -122.3290, 4.8, 'Sarah M.'),
...
('Seattle Children''s Museum', 'Museum', '305 Harrison St, Seattle, WA 98109',
 ...
 array['Soft Play','Nursing Area','Changing Facilities','High Chairs'], 47.6205, -122.3517, 4.6, 'James T.'),
...
('Ballard Commons Park', 'Park', '5701 22nd Ave NW, Seattle, WA 98107',
 ...
 array['Free Entry','Fenced Area','Pram Accessible'], 47.6687, -122.3836, 4.5, 'Maria L.'),
...
('Burke Museum of Natural History', 'Museum', '4300 15th Ave NE, Seattle, WA 98105',
 ...
 array['Free Entry','Pram Accessible'], 47.6601, -122.3094, 4.4, 'Anna K.'),
...
('Volunteer Park', 'Park', '1247 15th Ave E, Seattle, WA 98112',
 ...
 array['baby','toddler','preschool','bigkids'], array['wheelchair','blue_badge'],
 array['Free Entry','Pram Accessible','Enclosed Outdoor Space'], 47.6374, -122.3151, 4.7, 'Tom R.'),
...
('Westcrest Park', 'Park', '9000 8th Ave SW, Seattle, WA 98106',
 ...
 array['toddler','preschool','bigkids','tweens'], array['wheelchair'],
 array['Free Entry','Fenced Area'], 47.5284, -122.3446, 4.3, 'Priya S.'),
...
('Magnuson Park', 'Park', '7400 Sand Point Way NE, Seattle, WA 98115',
 ...
 array['Free Entry','Pram Accessible','Fenced Area','Enclosed Outdoor Space'], 47.6788, -122.2560, 4.6, 'Chris D.'),
...
('Seattle Public Library — Central Branch', 'Library', '1000 4th Ave, Seattle, WA 98104',
 ...
 array['Free Entry','Pram Accessible','Nursing Area','Quiet Space'], 47.6065, -122.3321, 4.5, 'Lena W.'),
...
('Fremont Sunday Market Café', 'Café', '3401 Evanston Ave N, Seattle, WA 98103',
 ...
 array['High Chairs','Nursing Area','Changing Facilities','Pram Accessible'], 47.6497, -122.3508, 4.2, 'Rachel B.'),
...
('Woodland Park Zoo', 'Attraction', '5500 Phinney Ave N, Seattle, WA 98103',
 ...
 array['Nursing Area','Changing Facilities','High Chairs','Pram Accessible','Café On Site'], 47.6685, -122.3503, 4.7, 'Oliver P.'),
...
('Bitter Lake Community Center', 'Attraction', '13035 Linden Ave N, Seattle, WA 98133',
 ...
 array['Soft Play','Changing Facilities','Nursing Area'], 47.7178, -122.3446, 4.1, 'Nina H.'),
...
('Cal Anderson Park', 'Park', '1635 11th Ave, Seattle, WA 98122',
 ...
 array['Free Entry','Pram Accessible'], 47.6165, -122.3188, 4.3, 'Jake F.'),
...
('Oxbow Farm & Conservation Center', 'Attraction', '10819 Carnation Duvall Rd NE, Carnation, WA 98014',
 ...
 array['Free Entry','Enclosed Outdoor Space','Pram Accessible'], 47.6497, -121.9160, 4.5, 'Emma C.'),
...
('Third Place Books Seward Park', 'Library', '5041 Wilson Ave S, Seattle, WA 98118',
 ...
 array['Free Entry','Nursing Area','Café On Site','Pram Accessible'], 47.5503, -122.2679, 4.6, 'Keiko M.'),
...
('Alki Beach Park', 'Park', '1702 Alki Ave SW, Seattle, WA 98116',
 ...
 array['Free Entry','Pram Accessible'], 47.5760, -122.4132, 4.8, 'Dan S.'),
...
('PlayDate SEA', 'Attraction', '1275 Mercer St, Seattle, WA 98109',
 ...
 array['baby','toddler','preschool','bigkids'], array['wheelchair','changing_places'],
 array['Soft Play','High Chairs','Café On Site','Changing Facilities','Nursing Area','Pram Accessible'], 47.6239, -122.3368, 4.5, 'Priya S.'),
...
('Seattle Aquarium', 'Attraction', '1483 Alaskan Way Pier 59, Seattle, WA 98101',
 ...
 array['Pram Accessible','Changing Facilities','Café On Site','High Chairs'], 47.6069, -122.3426, 4.7, 'Rachel B.'),
...
('Ballard Locks (Hiram M. Chittenden Locks)', 'Attraction', '3015 NW 54th St, Seattle, WA 98107',
 ...
 array['baby','toddler','preschool','bigkids','tweens'], array['wheelchair','blue_badge'],
 array['Free Entry','Pram Accessible','Enclosed Outdoor Space'], 47.6654, -122.3970, 4.8, 'Tom R.'),
...
('Artists at Play — Seattle Center', 'Playground', '305 Harrison St, Seattle, WA 98109',
 ...
 array['Free Entry','Pram Accessible','Sensory Sessions'], 47.6214, -122.3517, 4.7, 'Maria L.'),
...
('Frye Art Museum', 'Museum', '704 Terry Ave, Seattle, WA 98104',
 ...
 array['Free Entry','Pram Accessible','Café On Site','Changing Facilities'], 47.6074, -122.3240, 4.4, 'Lena W.');
